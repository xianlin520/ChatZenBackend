...
public class GeneratorMySQL {
     ...
     * 作者
     */
    public static final String AUTHOR = "羡林i";
    /**
     * java代码保存目录
     */
//    public static final String SAVE_PATH = System.getProperty("user.dir") + "/src/main/java";
    public static final String SAVE_PATH = "C:\\Users\\wanga\\IdeaProjects\\ChatZenBackend" + "/src/main/java";
    /**
     * xml保存目录
     */
     ...
     * 保存到包下面
     */
    public static final String PACKAGE = "vip.xianlin";
    /**
     * 要生成的表
     */
